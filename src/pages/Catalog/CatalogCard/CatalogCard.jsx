...
import innovation_icon from "../../../assets/img/Other/innovation_icon.png";
import motorsport_icon from "../../../assets/img/Other/motorsport_icon.png";
...
export function CatalogCard(props){
    ...
    function checktype(){
        ...
        else if((props.type) == 'petrol'){
            return "Бензин";
        }
        else if((props.type) == 'diesel'){
            return "Дизель";
        }
        else if((props.type) == 'petrolanddiesel'){
    ...
    function checkseries(series){
        if(series == "innovation"){
            return innovation_icon;
        }
        else if(series == "motorsport"){
    ...
    function checknovelty(){
        if((props.novelty) == 'new'){
            return <p className="card__novelty">НОВИНКА</p>;
        }
        else if((props.novelty) == 'old'){
    ...
    return(
        ...
        <button className="card">
            <div className="card__imgs">
                <img className='card__series' src={checkseries(props.series)} alt="" />
            ...
            <div className="card__bottom">
                <p className='price'>Цена от {props.price} ₽</p>
                <button className='card__info'>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className='card__info-path' d="M12 22.75C6.07 22.75 1.25 17.93 1.25 12C1.25 6.07 6.07 1.25 12 1.25C17.93 1.25 22.75 6.07 22.75 12C22.75 17.93 17.93 22.75 12 22.75ZM12 2.75C6.9 2.75 2.75 6.9 2.75 12C2.75 17.1 6.9 21.25 12 21.25C17.1 21.25 21.25 17.1 21.25 12C21.25 6.9 17.1 2.75 12 2.75Z" fill="#000"/>
